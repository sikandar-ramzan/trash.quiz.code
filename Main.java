...
public class Main {
    ...
    public static void main(String[] args) {
        JFrame P= new JFrame("Quizzer v1.00");
        P.setSize(800, 600);
...
//        print();
        ...
        final JRadioButton R3=new JRadioButton();
        R3.setBounds(40 ,205 ,30,20);

        final JRadioButton R4=new JRadioButton();
...
//                String Y=l5.getText();
                if (R1.isSelected())
                {
                    ...
                    // JLabel l5=new JLabel("your Answer is");
                    // l5.setBounds(500 ,500 ,200,100 );
                    //System.out.println("your answer is right " +Y);
                }
...
//         meri jaan pehla frame edhr takk hei agy dusra frame hei
        ...
        final JFrame P1= new JFrame("Online Test");
        P1.setLayout(null);
